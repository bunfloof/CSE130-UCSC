...
3. Dirty bit is set when page has been modified (written to).
...
4. Potentially increased page faults - If active parts of memory (working set) span across more pages due to a larger page size, it could lead to more page faults when the working set can not be fully loaded in o available memory.
